...
forj:   CMP EDI,0
		...
		MULPS  XMM0,XMM1   ;risultato[i] * div; 

		
		SUBPS XMM2,XMM0	   ;pTheta[i] - risultato[i]*div;    
		MOVAPS[EAX],XMM2   ;pTheta[i]=pTheta[i] -risultato[i]*div;   	
...
fori:	CMP ESI,0
		...
		MULSS  XMM0,XMM1   ;risultato[i] * div; 

		SUBSS XMM2,XMM0	   ;pTheta[i] - risultato[i]*div;    
		MOVSS[EAX],XMM2    ;pTheta[i]=pTheta[i] -risultato[i]*div;   
